...
class Product {
  ...
  String? validateForCreate() {
    ...
    if (barcode == null || barcode!.trim().isEmpty) return 'Barcode is required';
    if (buyprice == null || buyprice! < 0) return 'Buy price must be non-negative';
    if (sellPrice == null || sellPrice! < 0) return 'Sell price must be non-negative';
    ...
    if (offer == true && offerPrice != null && buyprice != null && sellPrice != null) {
